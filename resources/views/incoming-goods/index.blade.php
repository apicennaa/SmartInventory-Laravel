...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Incoming Goods</h1>
</div>
...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('incoming-goods.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg">
                + Add Incoming Goods
            </a>
        </div>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{ $item->incoming }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="{{ route('incoming-goods.edit', $item->id) }}" class="text-blue-600 hover:text-blue-900">
